    ...
    <div className="fd-page-chrome mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-9 lg:px-8">
      <header className="mb-8 grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
        <div>
          ...
          <p className="text-sm font-medium text-indigo-700">FlowDock / About</p>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-x-4 gap-y-2.5">
            ...
            <Link href="/docs" className="inline-flex items-center gap-1 text-sm font-medium text-indigo-700 transition hover:text-violet-700">
              <span>看文档路径</span>
              <span aria-hidden>→</span>
            </Link>
          </div>
        ...
        <Card className="rounded-[28px] border border-slate-200 bg-indigo-950 py-0 text-white shadow-sm fd-dark-card">
          ...
          <CardContent className="space-y-3.5 pb-5 text-sm leading-6 text-slate-200">
      ...
      <section className="mb-8 grid gap-3 sm:grid-cols-3">
        {pageLens.map((item, index) => (
          <div key={item.label} className={index === 1 ? "rounded-[24px] border border-slate-200 bg-indigo-950 px-4 py-3.5 text-white shadow-sm" : index === 2 ? "hidden rounded-[24px] border border-slate-200 bg-indigo-50/70 px-4 py-3.5 shadow-sm fd-soft-card sm:block" : "rounded-[24px] border border-slate-200 bg-indigo-50/70 px-4 py-3.5 shadow-sm fd-soft-card"}>
            <p className={index === 1 ? "text-xs font-medium uppercase tracking-[0.18em] text-violet-200" : "text-xs font-medium uppercase tracking-[0.18em] text-slate-400"}>{item.label}</p>
      ...
      <section className="mb-8 hidden rounded-[28px] border border-slate-200 bg-white py-0 shadow-sm fd-glass-card sm:block">
        <CardHeader>
        ...
        <CardContent className="space-y-3 pb-5">
          <div className="grid gap-3 sm:grid-cols-3">
            {rhythmStrip.map((item, index) => (
              <div key={item.label} className={index === 1 ? "rounded-2xl border border-slate-200 bg-indigo-950 px-4 py-3 text-white" : index === 2 ? "hidden rounded-2xl border border-slate-200 bg-indigo-50/70 px-4 py-3 sm:block" : "rounded-2xl border border-slate-200 bg-indigo-50/70 px-4 py-3"}>
                <p className={index === 1 ? "text-xs font-medium uppercase tracking-[0.18em] text-violet-200" : "text-xs font-medium uppercase tracking-[0.18em] text-slate-400"}>{item.label}</p>
                <p className={index === 1 ? "mt-2 text-sm font-medium leading-6 text-white" : "mt-2 text-sm font-medium leading-6 text-slate-900"}>{item.value}</p>
              </div>
            ))}
          </div>
          <div className="rounded-2xl border border-slate-200 bg-indigo-50/70 px-4 py-3">
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="mt-2 grid gap-3 sm:grid-cols-3">
                {leavePageStrip.map((item, index) => (
                  <Link key={item.label} href={item.href} className={index === 1 ? "rounded-2xl border border-slate-200 bg-indigo-950 px-4 py-3 text-white shadow-sm" : "rounded-2xl border border-slate-200 bg-indigo-50/70 px-4 py-3 shadow-sm fd-soft-card"}>
                    <p className={index === 1 ? "text-xs font-medium uppercase tracking-[0.18em] text-violet-200" : "text-xs font-medium uppercase tracking-[0.18em] text-slate-400"}>{item.label}</p>
                    <p className={index === 1 ? "mt-2 text-sm font-medium leading-6 text-white" : "mt-2 text-sm font-medium leading-6 text-slate-900"}>{item.value}</p>
                  </Link>
                ))}
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white/82 px-4 py-3 backdrop-blur-xl">
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-3.5 lg:grid-cols-3">
          {decisionPoints.map((item, index) => (
            <Card key={item.title} className={index === 2 ? "hidden rounded-[28px] border border-slate-200 bg-indigo-50/70 py-0 shadow-sm lg:block" : "rounded-[28px] border border-slate-200 bg-indigo-50/70 py-0 shadow-sm"}>
      ...
      <section className="mb-8 rounded-[32px] border border-slate-200 bg-indigo-50/70 p-3.5 shadow-sm sm:p-4">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {taskFirstRoutes.map((item, index) => (
            <div key={item.title} className={index === 0 ? "rounded-[24px] border border-slate-200 bg-indigo-950 p-3.5 text-white shadow-sm" : index === 2 ? "hidden rounded-[24px] border border-slate-200 bg-white p-3.5 shadow-sm md:block" : "rounded-[24px] border border-slate-200 bg-white p-3.5 shadow-sm"}>
              <p className={index === 0 ? "text-sm font-medium text-white" : "text-sm font-medium text-slate-950"}>{item.title}</p>
              <p className={index === 0 ? "mt-2 text-sm leading-6 text-slate-200" : "mt-2 hidden text-sm leading-6 text-slate-600 sm:block"}>{item.detail}</p>
              <Link
                href={item.href}
                className={
                  index === 0
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4 pb-6">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                {coreProblems.map((item, index) => (
                  <div key={item} className={index === 3 ? "hidden rounded-2xl border border-slate-200 bg-indigo-50/80 px-4 py-4 md:block" : "rounded-2xl border border-slate-200 bg-indigo-50/80 px-4 py-4"}>
          ...
          <Card className="rounded-[28px] border border-slate-200 bg-white py-0 shadow-sm fd-glass-card">
            ...
            <CardContent className="space-y-4 pb-6">
              ...
              <div className="rounded-2xl border border-slate-200 bg-indigo-50/70 p-4 text-sm leading-6 text-slate-600">
          ...
          <Card className="rounded-[28px] border border-slate-200 bg-white py-0 shadow-sm fd-glass-card">
            ...
            <CardContent className="grid gap-2.5 pb-5 md:grid-cols-3">
              {recommendedEntrances.map((item, index) => (
                <div key={item.title} className={index === 2 ? "hidden rounded-2xl border border-slate-200 bg-indigo-50/70 p-3.5 md:block" : "rounded-2xl border border-slate-200 bg-indigo-50/70 p-3.5"}>
                  <p className="text-sm font-medium text-slate-950">{item.title}</p>
                  <p className="mt-2 text-sm leading-[1.65] text-slate-600">{item.detail}</p>
                  <Link href={item.action.href} className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-indigo-700 transition hover:text-violet-700">
            ...
            <Card className="rounded-[28px] border border-slate-200 bg-white py-0 shadow-sm fd-glass-card">
              ...
              <CardContent className="space-y-3 pb-6 text-sm leading-6 text-slate-600">
                {goodFitUsers.map((item) => (
                  <p key={item} className="rounded-2xl bg-indigo-50/80 px-4 py-3">
                    {item}
                  </p>
                ))}
              </CardContent>
        ...
        <aside className="space-y-3.5 lg:sticky lg:top-24">
          <Card className="rounded-[28px] border border-slate-200 bg-indigo-950 py-0 text-white shadow-sm fd-dark-card">
            ...
            <CardContent className="flex flex-col gap-2.5 pb-5">
              <Link href="/diagnose" className="rounded-full bg-white px-5 py-3 text-center text-sm font-medium text-slate-950 transition hover:bg-indigo-100/80">
                进入配置诊断器
              </Link>
              <Link href="/templates" className="inline-flex items-center gap-1 text-sm font-medium text-violet-200 transition hover:text-white">
                <span>查看模板中心</span>
                <span aria-hidden>→</span>
              </Link>
              <Link href="/docs" className="inline-flex items-center gap-1 text-sm font-medium text-violet-200 transition hover:text-white">
                <span>查看文档路径</span>
                <span aria-hidden>→</span>
              </Link>
            </CardContent>
          ...
          <Card className="hidden rounded-[28px] border border-slate-200 bg-white py-0 shadow-sm fd-glass-card sm:block">
            <CardHeader>
            ...
            <CardContent className="space-y-2.5 pb-5 text-sm leading-6 text-slate-600">
              <p className="rounded-2xl bg-indigo-50/80 px-3.5 py-2.5">搭本地助手：先看 Use Cases / 本地 AI 助手搭建</p>
              <p className="rounded-2xl bg-indigo-50/80 px-3.5 py-2.5">排查切换问题：先去 Diagnose 或模型切换场景页</p>
              <p className="rounded-2xl bg-indigo-50/80 px-3.5 py-2.5">做自动化流程：先看 AI 工作流起步模板</p>
            </CardContent>
          </Card>
        </aside>
      </div>
