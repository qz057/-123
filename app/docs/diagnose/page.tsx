    ...
    <DocShell
      ...
      sections={[
        ...
        },
        {
          ...
          body: "当现场已经出现“改过两轮，但还是说不清到底哪一步生效”这种信号时，Diagnose 的作用就不再只是起步，而是帮你把已经发散的现场重新收回来。它会把显式问题类型、场景加权、关键词命中和字段完整度一起纳入归类，让你看见当前更像哪一类，而不是继续凭感觉硬试。",
          highlights: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "missing inputs 不是可有可无的提示，而是在提醒你为什么这轮别下太满的结论",
            "resource priority 的作用，是告诉你下一跳最关键的入口，而不是让你所有资源都点一遍",
          ],
          links: [
