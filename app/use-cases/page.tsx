    ...
    <div className="fd-page-chrome mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-9 lg:px-8">
      <header className="mb-8 grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
        ...
        <Card className="rounded-[28px] border border-slate-200 bg-indigo-950 py-0 text-white shadow-sm fd-dark-card">
          <CardHeader>
            <p className="text-xs font-medium uppercase tracking-[0.18em] text-slate-500">Use-case map</p>
      ...
      <section className="mb-7">
        <div className="mb-3.5">
          <p className="text-xs font-medium uppercase tracking-[0.18em] text-slate-500">Page questions</p>
      ...
      <section id="use-case-rules" className="mb-8 grid gap-3.5 xl:grid-cols-[1.04fr_0.96fr]">
        ...
        <Card className="rounded-[28px] border border-slate-200 bg-white py-0 shadow-sm fd-glass-card">
          <CardHeader>
            <p className="text-xs font-medium uppercase tracking-[0.18em] text-slate-500">Page promise</p>
          ...
          {useCasesCatalog.map((item, index) => (
            <Card key={item.slug} className="rounded-[28px] border border-slate-200 bg-white py-0 shadow-sm fd-glass-card">
              ...
              <CardContent className="space-y-3 pb-4">
                <div className="rounded-2xl bg-indigo-50/80 px-3.5 py-3 text-sm leading-[1.6] text-slate-600">
                ...
                <div className="rounded-2xl border border-slate-200 bg-indigo-50/65 px-3.5 py-3 shadow-[0_20px_52px_-40px_rgba(79,70,229,0.22)]">
                ...
                <div className="hidden rounded-2xl border border-slate-200 bg-indigo-50/65 px-3.5 py-3 shadow-[0_20px_52px_-40px_rgba(79,70,229,0.22)] sm:block">
...
function PromiseCard({ text }: { text: string }) {
  return <p className="rounded-2xl bg-indigo-50/80 px-3.5 py-2.5 text-sm leading-[1.65] text-slate-600">{text}</p>;
}
