  ...
  return (
    <section className="relative overflow-hidden bg-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-10 grid gap-6 md:grid-cols-[0.92fr_1.08fr] md:items-end">
        ...
        <div className="grid gap-6 md:grid-cols-[0.95fr_1.05fr]">
          <Card className="rounded-[1.75rem] border border-slate-200 bg-white py-0 shadow-sm">
            <CardHeader className="space-y-4 pb-4">
              <CardTitle className="text-xl text-slate-950">你只需要提供这些信息</CardTitle>
          ...
          <Card className="rounded-[1.75rem] border border-slate-200 bg-slate-950 py-0 text-white shadow-[0_22px_64px_-34px_rgba(15,23,42,0.55)]">
            <CardHeader className="space-y-4 pb-4">
              <div className="flex flex-wrap items-center gap-2">
                <CardTitle className="text-xl text-white">你会得到这样的结果</CardTitle>
            ...
            <CardContent className="space-y-4 pb-6 text-sm leading-6 text-slate-200">
              <div className="rounded-2xl border border-sky-300/15 bg-sky-400/10 p-4 text-slate-100">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link href="/docs/diagnose" className="inline-flex rounded-full border border-slate-300 bg-white px-5 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-50">
            先看 Diagnose 文档
          </Link>
        </div>
      </div>
