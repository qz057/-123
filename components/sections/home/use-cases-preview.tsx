    ...
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#ffffff_0%,#f8f7ff_100%)]">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="mb-8 grid gap-6 md:mb-10 md:grid-cols-[1fr_0.82fr] md:items-end">
          ...
          <div className="hidden rounded-[1.75rem] border border-slate-200 bg-indigo-50/85 p-5 shadow-sm md:block">
                ...
                <CardHeader className="space-y-3 pb-3 sm:space-y-4 sm:pb-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span
                      className={
                        primary
                          ? "rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-medium text-violet-200"
        ...
        <div className="mt-6 flex flex-wrap gap-3 sm:mt-8">
          <Link href="/use-cases" className="inline-flex rounded-full bg-indigo-950 px-5 py-3 text-sm font-medium text-white transition hover:bg-violet-900">
            查看全部场景
          </Link>
          <Link href="/templates" className="hidden rounded-full border border-indigo-200 bg-white px-5 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-50 sm:inline-flex">
            继续看模板中心
          </Link>
        </div>
      </div>
